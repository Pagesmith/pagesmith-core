(function(){
  'use strict';
  /*globals Raphael: true, Chartsmith: true */
  ...
  */
  ...
  Chartsmith.Genbank.prototype = {
    filter_features: function () {
      var j, type, fs, renderer, new_features, exclusion_hash, k;
      ...
      for (l = f.loc.length; l; l) {
        ...
        if ((st < 0) && (l === 0)) { // This is the lh end...
          if (s + this.diagonal > e) {
            ...
            pts = [ e, {val: f.track, off: -0.4},
                    s + this.diagonal, {val: f.track, off: -0.4},
                    s, {val: f.track, off: -0.3},
                    s + this.diagonal, {val: f.track, off: -0.2},
                    e, {val: f.track, off: -0.2} ];
          }
        } else {
          if ((st > 0) && (l === f.loc.length - 1)) {
            if (s + this.diagonal > e) {
              ...
              pts = [ e, {val: f.track, off: -0.3},
                      e - this.diagonal, {val: f.track, off: -0.4},
                      s, {val: f.track, off: -0.4},
                      s, {val: f.track, off: -0.2},
                      e - this.diagonal, {val: f.track, off: -0.2} ];
            }
          } else {
