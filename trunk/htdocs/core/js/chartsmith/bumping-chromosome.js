(function(){
  ...
  Raphael.fn.cs_ideogram_render =  function () {
    var karyo_set = this.set(),
        width = this.cs_ideogram.width,
        name  = 'Chr ' + this.cs_ideogram.chr,
        end   = this.cs_ideogram.end,
        bands = this.cs_ideogram.bands,
        flag  = 0,
        j, start, pts, s, e, col, o;
